...
loadmaster's no-hard-wrap discipline (see README.md) requires every markdown
...
This script is shared by the local `commit-msg` hook. It only *detects*
violations; it never rewrites anything.
